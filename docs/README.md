...
| **[Development Conventions](./development-conventions.md)** | Coding standards, naming conventions, and best practices | All Developers, Contributors |

| **[Development Workflows](./development-workflows.md)** | Step-by-step procedures for common development tasks | Developers, DevOps, Project Managers |### 📋 **Project History**

| **[Testing Guide](./testing-guide.md)** | Comprehensive testing strategies, patterns, and best practices | QA Engineers, Developers, Test Automation |- **[Modernization Guide](./MODERNIZATION.md)** - Complete modernization process and changes made
...
### For New Developers1. **New Developer Setup**: Start with [Developer Guide](./DEVELOPER_GUIDE.md)

1. Read **[Tech Stack Overview](./tech-stack.md)** to understand the technology foundation2. **Architecture Understanding**: Read [Architecture Guide](./ARCHITECTURE.md)

2. Study **[Development Conventions](./development-conventions.md)** for coding standards3. **Component Development**: Reference [Component Documentation](./COMPONENT_DOCUMENTATION.md)
